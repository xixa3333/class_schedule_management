...
extension CourseQueryFilter on QueryBuilder<Course, Course, QFilterCondition> {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> enableNotificationEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension CourseQuerySortBy on QueryBuilder<Course, Course, QSortBy> {
  ...
  QueryBuilder<Course, Course, QAfterSortBy> sortByEnableNotification() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enableNotification', Sort.asc);
    });
  }

  QueryBuilder<Course, Course, QAfterSortBy> sortByEnableNotificationDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CourseQuerySortThenBy on QueryBuilder<Course, Course, QSortThenBy> {
  ...
  QueryBuilder<Course, Course, QAfterSortBy> thenByEnableNotification() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enableNotification', Sort.asc);
    });
  }

  QueryBuilder<Course, Course, QAfterSortBy> thenByEnableNotificationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enableNotification', Sort.desc);
    });
  }
...
extension CourseQueryWhereDistinct on QueryBuilder<Course, Course, QDistinct> {
  ...
  QueryBuilder<Course, Course, QDistinct> distinctByEnableNotification() {
    return QueryBuilder.apply(this, (query) {
...
extension CourseQueryProperty on QueryBuilder<Course, Course, QQueryProperty> {
  ...
  QueryBuilder<Course, bool, QQueryOperations> enableNotificationProperty() {
    return QueryBuilder.apply(this, (query) {
